...
public class ConnectAvailabilityTest {

    @Test
    public void unavailableDiscoveryBacksOffWithoutRepeatingTheSameError() {
    ...
    @Test
    public void successfulRetryRestoresAvailabilityAndClearsBackoff() {
        ConnectAvailability availability = new ConnectAvailability();
