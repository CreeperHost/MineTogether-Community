...
public class EmoteRadialScreen extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            drawCenteredString(fontRendererObj, label, labelX, labelY - 4, activeTraversal ? 0xFFFFF0A8 : selectedSlice ? 0xFFFFFFFF : 0xFFD7DDE5);
        }
        ...
        if (selected >= 0) {
            ...
            int textWidth = fontRendererObj.getStringWidth(activeText);
            int y = centerY + OUTER_RADIUS + 14;
            ...
            drawCenteredString(fontRendererObj, activeText, centerX, y, 0xFFFFE08A);
        }
    }
