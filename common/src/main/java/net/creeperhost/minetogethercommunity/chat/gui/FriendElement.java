...
import net.creeperhost.minetogethercommunity.gui.dialogs.ContextMenu;
import net.creeperhost.minetogethercommunity.gui.dialogs.TextInputDialog;
        ...
        if (request == null) {
            ...
            GuiButton accept = MTStyle.Flat.buttonPrimary(this, Component.translatable("minetogether:gui.friends.button.accept"))
                    .onPress(() -> {
                        ...
                        new net.creeperhost.minetogethercommunity.gui.dialogs.TextInputDialog(getModularGui().getRoot(), Component.translatable("minetogether:screen.friendreq.desc.request"), FriendChatGui.displayName(profile))
