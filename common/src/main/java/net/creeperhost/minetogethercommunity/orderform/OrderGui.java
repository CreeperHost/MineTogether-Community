...
import net.creeperhost.minetogethercommunity.gui.dialogs.OptionDialog;
...
import net.creeperhost.minetogethercommunity.orderform.elements.DetailsElement;
import net.creeperhost.minetogethercommunity.orderform.elements.LocationElement;
import net.creeperhost.minetogethercommunity.orderform.elements.ServerConfigElement;
import net.creeperhost.minetogethercommunity.orderform.elements.WorldElement;
import net.creeperhost.minetogethercommunity.orderform.requests.GetDataCentresRequest.DC;
...
public class OrderGui implements GuiProvider {
    ...
    private void placeOrder(ModularGui gui) {
        ...
        orderTask = CompletableFuture.runAsync(() -> {
            ...
            var result = OrderRequests.placeOrder(order, getDCId(order.serverLocation), String.valueOf(getPromoCode()), computeFallbackLocation());
            if (result.getStatus().equals("success")) {
    ...
    //TODO, API request to check if promo exists for pack
    public String getPromoCode() {
        return "minetogetherer";
    }
